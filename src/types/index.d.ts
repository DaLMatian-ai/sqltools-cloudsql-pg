...
export interface IBaseQueries {
  ...
  fetchDatabaseMap?: QueryBuilder<never | MConnectionExplorer.IChildItem, NSDatabase.IDatabaseMap>;
...
export declare enum ContextValue {
  ...
  NO_CHILD = 'NO_CHILD',
  KEYWORDS = 'KEYWORDS',
  DATABASE_MAP = 'connection.database_map',
}
...
export namespace NSDatabase {
  export interface IDatabaseMap extends MConnectionExplorer.IChildItem {
    type: ContextValue.DATABASE_MAP;
